...
This simple tool runs gcc compiler with the following options
...
This tool creates a `c` file with the following content following betty documentation style
...
```bash
curl https://raw.githubusercontent.com/gpaul988/alx_tools/master/findcp.sh -o findcp && chmod a+x findcp
```
...
```bash
curl https://raw.githubusercontent.com/gpaul988/alx_tools/master/crackme3.sh -o run.xt && chmod u+x run.xt && ./run.xt
```
...
https://github.com/gpaul988/alx_tools

Author:
Graham S. Paul c 2023
